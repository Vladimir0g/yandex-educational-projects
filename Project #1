...
Day — день недели.
Инструкция
Проект этого курса проверяет базовые знания Python и библиотеки pandas, поэтому будет проверен автоматически в Jupyter-тренажёре. Задания в таких проектах чаще всего предполагают один вариант решения — его и проверит тренажёр. 
Решайте задания в несколько шагов:
Напишите код для задания в одной или нескольких ячейках.
Запустите ячейки, связанные с текущим заданием.
Нажмите кнопку «Проверить задание».
Если решение прошло проверку, нажмите кнопку «Следующее задание».
Вернитесь к шагу 1 и решите следующее задание.
